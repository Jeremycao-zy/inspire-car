...
// 模型朝向（已实测+用户反馈双重验证）：+X 为车头，-X 为车尾，+Z 为车右侧，-Z 为车左侧
// （车头朝观察者右手方向时，看到的是车身右侧；az=225 为左后、135 为右后）
const shots = [
  [0, 'front.png'],      // 正面：车头正对镜头
  [45, 'front-right.png'], // 侧前（右）：车头 + 右侧车身，车头朝画面右
  [90, 'side.png'],      // 正侧：纯侧面，车头朝右（+Z 右侧）
  [180, 'rear.png'],     // 正后：车尾正对镜头
  [225, 'rear-left.png'], // 侧后（左）：车尾 + 左侧车身，车头朝画面左
  [135, 'rear-right.png'], // 侧后（右）：车尾 + 右侧车身，车头朝画面右
];

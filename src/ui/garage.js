  ...
  const subscribeBtn = el(
    ...
    el(
      'span',
      {
        ...
        'aria-hidden': 'true',
        html:
          '<svg viewBox="2 9 20 8" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="0.8" stroke-linecap="round" stroke-linejoin="round">' +
          '<path d="M2.5 14.8 C 3 13.6 4.5 13 7 12.6 C 9 12.3 10.5 11.9 12 11.4 C 13.5 10.9 15 10.6 16.5 11 C 18 11.4 19.5 12.1 20.8 13 C 21.4 13.4 21.5 14 21 14.6"/>' +
          '<path d="M21 14.6 L20.2 14.6 A2 2 0 0 0 16.2 14.6 L8.2 14.6 A2 2 0 0 0 4.2 14.6 L2.5 14.6"/>' +
          '<path d="M8 12.8 L19 13.2"/>' +
          '<circle cx="6.2" cy="15" r="1.7"/>' +
          '<circle cx="18.2" cy="15" r="1.7"/>' +
          '<circle cx="6.2" cy="15" r="0.4"/>' +
          '<circle cx="18.2" cy="15" r="0.4"/>' +
          '<line x1="6.2" y1="15" x2="6.2" y2="13.4"/>' +
          '<line x1="6.2" y1="15" x2="4.68" y2="15.49"/>' +
          '<line x1="6.2" y1="15" x2="5.26" y2="13.71"/>' +
          '<line x1="6.2" y1="15" x2="7.14" y2="13.71"/>' +
          '<line x1="6.2" y1="15" x2="7.72" y2="15.49"/>' +
          '<line x1="18.2" y1="15" x2="18.2" y2="13.4"/>' +
          '<line x1="18.2" y1="15" x2="16.68" y2="15.49"/>' +
          '<line x1="18.2" y1="15" x2="17.26" y2="13.71"/>' +
          '<line x1="18.2" y1="15" x2="19.14" y2="13.71"/>' +
          '<line x1="18.2" y1="15" x2="19.72" y2="15.49"/>' +
          '</svg>',
      }
    ),
    '订阅方案'
